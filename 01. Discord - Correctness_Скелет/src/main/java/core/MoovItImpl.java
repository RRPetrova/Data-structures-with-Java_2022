        ...
        LinkedHashMap<Route, Integer> collect = distancePoints
                ...
                .sorted((a, b) -> {
                    ...
                    if (cmp == 0) {
                        ...
                        if (cmp == 0) {
                            return b.getKey().getPopularity() - a.getKey().getPopularity();
                        }
                    }
                    return cmp;
...
//                        .thenComparing(Route::getPopularity).reversed())
                .sorted((a, b) ->
                {
                    int cmp = Comparator.comparingDouble(a.getDistance(), b.getDistance());
                    if (cmp == 0) {
    ...
    public Iterable<Route> getTop5RoutesByPopularityThenByDistanceThenByCountOfLocationPoints() {
        return this.routesById
                ...
                .stream()
                .sorted((a, b) -> {
                            int cmp = b.getPopularity() - a.getPopularity();
                            if (cmp == 0) {
