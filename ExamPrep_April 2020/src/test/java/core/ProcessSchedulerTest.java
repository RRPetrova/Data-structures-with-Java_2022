...
public class ProcessSchedulerTest {
    ...
    public void testInsert() {
        ...
        scheduler.add(new ScheduledTask(5, "test_description"));
        scheduler.add(new ScheduledTask(8, "test_description"));
        scheduler.add(new ScheduledTask(10, "test_description"));
        scheduler.add(new ScheduledTask(12, "test_description"));

        assertNotNull(scheduler.peek());
        scheduler.insertBefore(10, new ScheduledTask(55, "test_description"));

    }

    @Test
    public void testInsertAft() {
        Scheduler scheduler = new ProcessScheduler();
        assertNull(scheduler.peek());
        assertEquals(0, scheduler.size());
        ...
        assertNotNull(scheduler.peek());
        scheduler.insertAfter(10, new ScheduledTask(55, "test_description"));
